...
- [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/thegeneralsystem/dfipy-examples/HEAD?labpath=examples%2Fdfipy_quick_start_geolife.ipynb) - `dfipy` basics, querying a small dataset of 25 millions records ([Geolife dataset](https://www.microsoft.com/en-us/research/publication/geolife-gps-trajectory-dataset-user-guide/)).
