...
- [![Launch Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/thegeneralsystem/dfipy-examples/blob/main/examples/dfipy_quick_start_geolife.ipynb) - `dfipy` basics, querying a small dataset of 25 millions records ([Geolife dataset](https://www.microsoft.com/en-us/research/publication/geolife-gps-trajectory-dataset-user-guide/)).
...
- [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/thegeneralsystem/dfipy-examples/blob/main/examples/dfipy_quick_start_geolife.ipynb/HEAD) - `dfipy` basics, querying a small dataset of 25 millions records ([Geolife dataset](https://www.microsoft.com/en-us/research/publication/geolife-gps-trajectory-dataset-user-guide/)).
- [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/thegeneralsystem/dfipy-examples/blob/main/examples/dfipy_quick_start_syn_traffic.ipynb/HEAD) - Query a large synthetic traffic dataset of 92 billion records using a streaming API.
- [![Open in Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/thegeneralsystem/dfipy-examples/blob/main/examples/dfipy_quick_start_create_a_polygon.ipynb/HEAD) - A beginner's guide to draw polygons on a map and then query the DFI.
...
| :----------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `dfipy_quick_start_geolife.ipynb`    | `dfipy` basics, querying a small dataset of 25 millions records ([Geolife dataset](https://www.microsoft.com/en-us/research/publication/geolife-gps-trajectory-dataset-user-guide/)). |
